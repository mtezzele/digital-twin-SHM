...
class GetSetup:
    ...
    :param int n_level_step: number of points resulting from the discretization 
        of damage level.
    ...
    def _get_low_diag_transition(self, prob_adv): # CHANGED
        """
        ...
        may starts in any zone with low magnitude and grows with one-step increments. 
        It is also assumed an equal probability of advancement for the undamaged and 
